...
export default function HeroCourses() {
  ...
  // Static course data
  const name = "Master React with Tailwind CSS";
  const instructor = "Ahmed Khalied";
  const price = 100;
  const discount = 40;
  const discountedPrice = price - discount;
  const rating = 4.7;
  const students_rated = 1245;
  const overview =
    "This course provides an in-depth guide to building responsive, modern UIs with React and Tailwind CSS. You'll learn practical skills by creating real-world projects.";
      ...
      <div className="relative h-screen">
        ...
        <div className="absolute inset-0 w-full h-full z-0 overflow-hidden">
          <iframe
            ...
            src="https://www.youtube.com/embed/dGcsHMXbSOA?autoplay=1&mute=1&loop=1&playlist=dGcsHMXbSOA&controls=0&modestbranding=1&showinfo=0"
            ...
            <div>
              ...
              <div className="flex items-center gap-2 text-sm sm:text-base mb-6">
                <div className="flex items-center">
                  ...
                  <span className="text-yellow-400 font-semibold ml-1">{rating}/5</span>
                </div>
                <span className="text-gray-400">{students_rated} students</span>
              </div>
